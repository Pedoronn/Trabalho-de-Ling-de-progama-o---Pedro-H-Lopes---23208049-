...
class Program
{
    static void Main()
    {
        ...
        int BolaSorteada = random.Next(1, 21); //variável que vai sortear um número de 1 a 20.
        int alvo = BolaSorteada; // variável onde o algo é armazenado.
        int palpiteMaximo = 20; //variável onde o palpite maximo é armazenado.
        int palpiteMinimo = 1; //variável onde o palpite minimo é armazenado.
        int pontuacao = 0; // variável onde a pontuação é armazenada. 
        ...
        if (opcao == 2) // se a opção 2 for escolhida será mostrado o exemplo a seguir.
        {
        ...
        {
            Console.Write($"Uma nova bola foi sorteada, em qual seu palpite:{palpiteMinimo} Max:{palpiteMaximo}\n"); // É informado ao jogador que ele deve chutar um numero, levando em consideração o palpite minimo e maximo de 1 a 20.
            int palpite = int.Parse(Console.ReadLine()); // verifica se o palpite está dentro dos valores determinados.
          ...
          else // caso o palpite não seja igual ao alvo o jogo continua, mas somando pontos a cada rodada.
            {
                ...
                Console.WriteLine($"Você errou! O alvo selecionado era: {alvo}"); // informa ao jogador que o palpite está errado e mostra o alvo anteriormente escolhido.
        ...
        Console.WriteLine($"O computador ultrapassou 100 pontos. O computador venceu!"); // mensagem de que os pontos se acumularam até 100 e o computador venceu.
    }
